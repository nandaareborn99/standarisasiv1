...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <h1 class="m-0">{{ $title }} Data Katalog</h1>
                <ol class="breadcrumb">
            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header p-2 bg-dark">
                        <a href="{{ url('admin/master/katalog') }}" class="btn btn-success btn-sm">Kembali&ensp;
                                    ...
                                    <tr>
                                        ...
                                        <td width="100%">
                                            <input type="text" class="form-control" name="nama_katalog"
                                                value="{{ empty($form['data']) ? '' : $form['data']->nama_katalog }}"
                                                aria-describedby="helpId" placeholder="Masukkan nama katalog" required>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
